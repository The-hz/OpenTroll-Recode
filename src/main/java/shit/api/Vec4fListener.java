...
public interface Vec4fListener {
    public int layer();

    public long sequence();

    public Enum_WGunhs getObj15();
    ...
    implements Vec4fListener {
        ...
        @Override
        public Enum_WGunhs getObj15() {
            return Enum_WGunhs.ROUND_RECT_OUTLINE;
        }
    ...
    implements Vec4fListener {
        ...
        private final BufferUtilDataManager bufferUtilDataManager;

        public Vec4fData5(int n, long l, Vec4f vec4f, ColorData colorData, String string, float f, float f2, float f3, Color color, BufferUtilDataManager bufferUtilDataManager) {
            this.layer = n;
            this.sequence = l;
            this.bounds = vec4f;
            this.scissor = colorData;
        ...
        public BufferUtilDataManager getBufferUtilDataManager() {
    ...
    implements Vec4fListener {
        ...
        private final Vec4f bounds;
        private final ColorData scissor;
        private final Listener6 listener6;
        ...
        public Vec4fData(int n, long l, Vec4f vec4f, ColorData colorData, Listener6 listener6, float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, Color color) {
            this.layer = n;
            this.sequence = l;
            this.bounds = vec4f;
            this.scissor = colorData;
