...
public class BoxOutlineRenderer
implements FrameListener {
    ...
    private GpuPipelineFactory.Data data3;

    private BoxOutlineRenderer() {
    }

    public static BoxOutlineRenderer getOutline32() {
        return (BoxOutlineRenderer)FrameListenerManager.manager4.addListener(new BoxOutlineRenderer());
    }
    ...
    public void draw2() {
        ...
        GpuPipelineFactory.Data data = GpuPipelineFactory.m1023(this.count171);
        if (data == null) {
            return;
        }
        ...
        if (this.flag70 && !RenderScissorHelper.isPositiveArea(this.count114, this.count136)) {
            return;
        }
        try (RenderPass renderPass = RenderSystem.getDevice().createCommandEncoder().createRenderPass(
                () -> "Round Rect I18nHelper Draw", data.getGpuTextureView3(), OptionalInt.empty(),
                data.getGpuTextureView2(), OptionalDouble.empty())) {
            renderPass.setPipeline(RenderPipelines.renderPipeline13);
            if (this.flag70) {
                RenderScissorHelper.enableScissor(renderPass, this.count66, this.count82, this.count114, this.count136);
            }
    ...
    public boolean prepareBuffers() {
        ...
        this.data3 = GpuPipelineFactory.m369(this.count171, false);
        if (this.data3 == null) {
            return false;
        }
    ...
    public void drawWithPass(Object object) {
        ...
        String[] stringArray = TextureRenderer.getTextArray3();
        BoxOutlineRenderer outline3 = this;
        if (stringArray != null) {
    ...
    private static /* synthetic */ String cfrlam$draw$0() {
        return "Round Rect I18nHelper Draw";
    }
}
