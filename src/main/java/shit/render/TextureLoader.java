...
public final class TextureLoader {
    ...
    public static ResourceEntry fetchSkin(Object object) {
        ...
        ResourceEntry resourceEntry = TextureLoader.m481(string);
        Object var3_4 = null;
        if (resourceEntry != null) {
            return resourceEntry;
        }
        try {
            String string3 = TextureLoader.m330(string);
            if (string3 == null) {
                return null;
            }
            Data data = TextureLoader.m408(string3);
            if (data == null) {
                return null;
            }
            NativeImage nativeImage = TextureLoader.m296(data);
            if (nativeImage == null) {
                return null;
            }
            Identifier identifier = Identifier.of((String)"trollhack-recode", (String)("skin/custom_" + TextureLoader.m525(string2)));
    ...
    private static String m330(Object object) throws Exception {
        ...
        HttpURLConnection httpURLConnection = TextureLoader.m1052(uRL, 5000);
        Object var3_4 = null;
        try {
            ...
            JsonObject jsonObject = TextureLoader.m22(httpURLConnection);
        ...
        try {
            ...
            block19: {
                block18: {
                    ...
                    JsonObject jsonObject3 = TextureLoader.m22(httpURLConnection);
    ...
    private static NativeImage m296(Object object) throws Exception {
        ...
        HttpURLConnection httpURLConnection = TextureLoader.m1052(URI.create(data.text12()).toURL(), 10000);
        Object var3_3 = null;
        try {
            if (httpURLConnection.getResponseCode() != 200) {
