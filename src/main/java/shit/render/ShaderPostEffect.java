...
public class ShaderPostEffect {
    public static final ShaderPostEffect shaderEffect = new ShaderPostEffect();
                ...
                block5: {
                    ...
                    block4: {
                        ...
                        block2: {
                            ...
                            data = (Data)object3;
                            data4 = (Data4)object4;
                            moduleArray = ShaderPostEffect.getModuleArray4();
    ...
    private Data3 m940(int n, int n2, Object object, Object object2) {
        ...
        float f3 = Math.max(1.0f, GpuPipelineFactory.getFloat57());
        float f4 = Math.max(1.0f, GpuPipelineFactory.getFloat53());
        ...
        return new Data3(GpuPipelineFactory.m1027("shader_params", "TrollHack Shader Params UBO", count93, 8, new Vec13f(f, f2, data.value99(), data.value100(), data.isSet10() ? -1.0f : ShaderPostEffect.m6(color), data.getFloat21() / 255.0f, data.value102() / 255.0f, (float)(Util.getMeasuringTimeMs() % 100000L) / 1000.0f, data.getFloat(), data.getFloat37(), data.value105(), f3, f4)), GpuPipelineFactory.m1027("shader_colors", "TrollHack Shader Colors UBO", count84, 8, new Data2(color, color2, color3, color4, color5, color6)));
    }

    private void m831() {
        block3: {
            block2: {
                Module[] moduleArray = ShaderPostEffect.getModuleArray4();
                ShaderPostEffect shaderEffect = this;
                if (moduleArray == null) break block2;
            ...
            shaderEffect.renderPipeline14 = RenderPipeline.builder((RenderPipeline.Snippet[])new RenderPipeline.Snippet[]{RenderPipelines.POST_EFFECT_PROCESSOR_SNIPPET}).withLocation(ResourceLoader.m52("pipelines/shader_copy")).withVertexShader("core/screenquad").withFragmentShader(ResourceLoader.m52("shader_copy")).withSampler("InputSampler").withCull(false).build();
        }
    }
    ...
    implements DynamicUniformStorage.Uploadable {
        ...
        public void write(ByteBuffer byteBuffer) {
            block0: {
                Module[] moduleArray = ShaderPostEffect.getModuleArray4();
                Std140Builder.intoBuffer((ByteBuffer)byteBuffer).putVec4(ShaderPostEffect.m693(this.color14), ShaderPostEffect.m95(this.color14), ShaderPostEffect.m939(this.color14), ShaderPostEffect.m6(this.color14)).putVec4(ShaderPostEffect.m693(this.color15), ShaderPostEffect.m95(this.color15), ShaderPostEffect.m939(this.color15), ShaderPostEffect.m6(this.color15)).putVec4(ShaderPostEffect.m693(this.color16), ShaderPostEffect.m95(this.color16), ShaderPostEffect.m939(this.color16), ShaderPostEffect.m6(this.color16)).putVec4(ShaderPostEffect.m693(this.color17), ShaderPostEffect.m95(this.color17), ShaderPostEffect.m939(this.color17), ShaderPostEffect.m6(this.color17)).putVec4(ShaderPostEffect.m693(this.color18), ShaderPostEffect.m95(this.color18), ShaderPostEffect.m939(this.color18), ShaderPostEffect.m6(this.color18)).putVec4(ShaderPostEffect.m693(this.color19), ShaderPostEffect.m95(this.color19), ShaderPostEffect.m939(this.color19), ShaderPostEffect.m6(this.color19));
    ...
    implements DynamicUniformStorage.Uploadable {
        ...
        public void write(ByteBuffer byteBuffer) {
            block0: {
                ShaderPostEffect.getModuleArray4();
                ...
                ShaderPostEffect.setModuleArray2(new Module[3]);
            }
        }
