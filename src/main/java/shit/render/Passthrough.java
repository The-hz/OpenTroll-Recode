...
public final class Passthrough {
            ...
            try {
                ...
                block17: {
                    ...
                    block16: {
                        ...
                        Passthrough.m183();
                        n20 = n21 = Passthrough.getInt21();
                        if (!bl2) break block16;
                        if (n20 == 0) {
                            drawContext.fill(n11, n10, n11 + n9, n10 + n8, n7);
                            return;
                        }
                        Passthrough.m(n21, n12, n11, n10, n9, n8, bl3);
                        Passthrough.m595(n21, client.getWindow().getFramebufferWidth(), client.getWindow().getFramebufferHeight());
                        Passthrough.m645(n11, n10, n9, n8);
                ...
                Passthrough.m696(drawContext2, n19, n18, n17, n16, n15);
            }
            catch (Throwable throwable) {
                Passthrough.m122(bl3, "failed: {}", new Object[]{throwable.toString()});
                Passthrough.m595(Passthrough.getInt74(), client.getWindow().getFramebufferWidth(), client.getWindow().getFramebufferHeight());
                ...
                Passthrough.m696(drawContext3, n22, n23, n24, n25, n26);
            }
        }
    }
    ...
    public static void m638() {
        ...
        if (Module.getTextArray9() == null) {
            Passthrough.setFlag15(!false);
        }
    }

    private static void m183() {
        boolean bl = Passthrough.isSet38();
        ...
        if (bl) {
            ...
            Passthrough.shaderProgram = new ShaderProgram("passthrough.vert", "passthrough.frag");
    ...
    private static void m(int n, int n2, int n3, int n4, int n5, int n6, boolean bl) {
        ...
        time21 = l;
        int tex = Passthrough.getInt46();
        if (tex > 0) {
            Passthrough.m683(tex, blur2);
        } else {
            Passthrough.m110(fbo, blur2);
        }
        int iterations = Math.max(2, Math.min(6, radius / 3));
        if (debug) {
            Passthrough.m683(blur2.count170, blur25);
        }
        Passthrough.m657(blur25, blur2.count170, blur2.count174, blur2.count162, 1.0f);
        for (int i = 0; i < iterations; ++i) {
            float offset = (float)i + 1.5f;
            Passthrough.m657(blur24, blur25.count170, blur25.count174, blur25.count162, offset);
            Passthrough.m657(blur25, blur24.count170, blur24.count174, blur24.count162, offset);
        }
        Passthrough.m657(blur24, blur25.count170, blur25.count174, blur25.count162, 1.0f);
    ...
    private static void m645(int n, int n2, int n3, int n4) {
        ...
        Pos.m437(Passthrough.blur24.count170, 0);
        shaderProgram4.m241("uTexture", 0);
        RenderUtil2.m73((float)n5 * f, (float)n6 * f2, (float)n7 * f, (float)n8 * f2, window.getFramebufferWidth(), window.getFramebufferHeight());
        GlStateManager._glUseProgram((int)0);
    ...
    private static void m122(boolean bl, Object object, Object object2) {
        ...
        boolean bl3 = Passthrough.isSet38();
        if (!bl2) {
            return;
        }
    ...
    private static String m495(Object object) {
        Blur2 blur2 = (Blur2)object;
        String string = Passthrough.m711(blur2.count170);
    ...
    private static String m143(int n, int n2, int n3, int n4, int n5) {
        ...
        String string = Passthrough.m87(byteBuffer.get(3));
        String string2 = Passthrough.m87(byteBuffer.get(2));
        String string3 = Passthrough.m87(byteBuffer.get(1));
        String string4 = Passthrough.m87(byteBuffer.get(0));
        int n14 = n12;
        int n15 = n11;
    ...
    private static String getText14() {
        ...
        for (int i = 0; i < 16; ++i) {
            ...
            stringBuilder.append(Passthrough.m31(n));
            if (!false) continue;
            break;
        }
