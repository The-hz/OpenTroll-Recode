...
import shit.misc.ModuleLabelRenderer;
...
extends ModuleState {
    ...
    private final List<shit.misc.ModuleLabelRenderer> list9 = new ArrayList<>();
    ...
    private final EasingAnimation nUWed = new EasingAnimation(EasingMode.OUT_CUBIC, 220.0f);

    public ModuleListRenderer(TextRenderer textRenderer, Category category, int n, int n2) {
        ...
        for (Module module : Client.moduleManager.getByCategory((Object)category)) {
            this.list9.add(new ModuleLabelRenderer(textRenderer, module, new ModuleSettingRenderer(textRenderer, module)));
            if (n3 != 0) continue;
        }
    }
    ...
    public void m213(Object object, int n, int n2) {
        block10: {
            ...
            if (n3 > 15) {
                ...
                for (ModuleLabelRenderer renderUtil : this.list9) {
            ...
            ModuleSettingRenderer.setInt3(++n4);
        }
    }
    ...
    public void m147(Object object, int n, int n2) {
        ...
        while (iterator.hasNext()) {
            block4: {
                ModuleSettingRenderer renderManager2;
                block3: {
                    ModuleSettingRenderer renderManager22;
                    ModuleLabelRenderer renderUtil = (ModuleLabelRenderer)iterator.next();
    ...
    public boolean m3(double d, double d2, int n) {
        ...
        for (int i = this.list9.size() - 1; i >= 0; --i) {
            ModuleSettingRenderer renderManager2 = ((ModuleLabelRenderer)this.list9.get(i)).getRenderManager2();
            ...
            while (n3 >= 0) {
                block4: {
                    block5: {
                        boolean bl2;
                        block6: {
                            ModuleSettingRenderer renderManager2 = ((ModuleLabelRenderer)this.list9.get(n3)).getRenderManager2();
            ...
            while (n >= 0) {
                block4: {
                    block5: {
                        boolean bl2;
                        block6: {
                            ModuleSettingRenderer renderManager2 = ((ModuleLabelRenderer)this.list9.get(n)).getRenderManager2();
                ...
                block12: {
                    block13: {
                        ...
                        block8: {
                            ...
                            d4 = d3;
                            Iterator iterator = this.list9.iterator();
                            n2 = ModuleSettingRenderer.getInt52();
                            while (iterator.hasNext()) {
                                block10: {
                                    boolean bl2 = false;
                                    block11: {
                                        block9: {
                                            ModuleLabelRenderer renderUtil = (ModuleLabelRenderer)iterator.next();
                                            ModuleSettingRenderer renderManager2 = renderUtil.getRenderManager2();
                                            bl = renderManager2.isSet60();
    ...
    public boolean m510(double d, double d2, int n) {
        boolean bl;
        block9: {
            ModuleListRenderer renderManager;
            int n2;
            int n3;
            double d3;
            double d4;
            ...
            for (ModuleLabelRenderer renderUtil : renderManager.list9) {
                block17: {
                    boolean bl3 = false;
                    block18: {
                        block16: {
            ...
            block9: {
                block7: {
                    ...
                    block6: {
                        d4 = d;
                        d3 = d2;
                        n = ModuleSettingRenderer.getInt52();
                        bl = this.flag16;
                        if (n == 0) break block6;
                        if (bl) break block7;
                        renderManager = this;
    ...
    public void setObj87(Object object) {
        ...
        do {
            boolean bl;
            ModuleLabelRenderer renderUtil;
            block5: {
                block4: {
                    String string2;
                    block3: {
                        if (!iterator.hasNext()) return;
                        renderUtil = (ModuleLabelRenderer)iterator.next();
                        string2 = string;
                        if (n == 0) break block3;
    ...
    private String m736(Object object) {
        ...
        if (I18nHelper.isSet130()) {
            return I18nHelper.m168((Object)category);
        }
