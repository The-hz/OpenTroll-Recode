...
public final class ShaderProgramManager {
    ...
    public static void render4(Object object, int n, int n2, double d, double d2) {
        block3: {
            ...
            boolean bl5 = false;
            int n7 = ShaderProgramManager.getInt39();
            try {
                if (n7 > 0) {
                ...
                ShaderProgramManager.m365(2929, bl);
                ShaderProgramManager.m365(3042, bl2);
                ShaderProgramManager.m365(2884, bl3);
                throw throwable;
            }
            GlStateManager._glUseProgram((int)n5);
            GlStateManager._glBindFramebuffer((int)36160, (int)n6);
