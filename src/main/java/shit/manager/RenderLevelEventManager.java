...
public final class RenderLevelEventManager
implements MC {
    private static final RenderLevelEventManager renderLevelEventManager = new RenderLevelEventManager();
    private Matrix4f matrix4f;
    private Matrix4f matrix4f7;

    private RenderLevelEventManager() {
    ...
    private static Matrix4f getMatrix4f2() {
        ...
        block3: {
            block2: {
                matrix4f2 = RenderLevelEventManager.renderLevelEventManager.matrix4f;
                Object var1_1 = null;
                matrix4f = RenderLevelEventManager.renderLevelEventManager.matrix4f7;
    ...
    public static Vector4d m676(Object object) {
        Vec3d vec3d;
        Box box = (Box)object;
        Matrix4f matrix4f = RenderLevelEventManager.getMatrix4f2();
        if (matrix4f == null) {
            return null;
        }
