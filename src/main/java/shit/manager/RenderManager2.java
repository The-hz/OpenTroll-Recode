...
extends ModuleState {
    ...
    private final List<None> list22;
    private final NUWed nUWed;
    ...
    public RenderManager2(TextRenderer textRenderer, Module module) {
        int n = RenderManager2.getInt52();
        this.list22 = new ArrayList();
        this.nUWed = new NUWed(Enum_NuWsin.OUT_EXPO, 220.0f);
            ...
            block13: {
                block12: {
                    block11: {
                        ...
                        n6 = n;
                        n5 = n2;
                        int n7 = RenderManager2.getInt52();
                        this.m438();
    ...
    public boolean m851(double d, double d2, int n) {
        ...
        int n2 = n;
        boolean bl = false;
        if (!this.m120(d3, d4, this.count108, this.count103, this.count141, this.getInt68())) {
            return false;
        }
        if (n2 == 0) {
            if (this.m270(d3, d4)) {
        ...
        if (this.m120(d3, d4, this.count108, this.count103, this.count141, 14)) {
            if (n2 == 1) {
                this.m109();
                return true;
            }
    ...
    public boolean m510(double d, double d2, int n) {
        ...
        return this.m120(d3, d4, this.count108, this.count103, this.count141, this.getInt68());
    }
    ...
    public boolean m671(double d, double d2, double d3) {
        ...
        double d6 = d3;
        int n = RenderManager2.getInt52();
        int n2 = this.m120(d4, d5, this.count108, this.count103, this.count141, this.getInt68()) ? 1 : 0;
        if (n != 0) {
            if (n2 == 0) {
                return false;
            }
    ...
    private boolean m270(double d, double d2) {
        ...
        boolean bl = this.m120(d3, d4, this.count108 - 3, this.count103 - 3, this.count141 + 6, n + 6);
        if (n2 != 0) {
            if (!bl) return false;
