...
extends Module {
    ...
    private final EnumSetting head = (EnumSetting)this.m28(new EnumSetting("Head", HeadMode.Protection));
    private final EnumSetting body = (EnumSetting)this.m28(new EnumSetting("Body", HeadMode.Protection));
    private final EnumSetting tights = (EnumSetting)this.m28(new EnumSetting("Tights", HeadMode.Protection));
    private final EnumSetting feet = (EnumSetting)this.m28(new EnumSetting("Feet", HeadMode.Protection));
    private final BooleanSetting ignoreCurse = (BooleanSetting)this.m28(new BooleanSetting("IgnoreCurse", true));
    private final BooleanSetting noMove = (BooleanSetting)this.m28(new BooleanSetting("NoMove", false));
    private final NumberSetting delay = (NumberSetting)this.m28(new NumberSetting("Delay", 3.0, 0.0, 10.0, 1.0));
    public final BooleanSetting autoElytra = (BooleanSetting)this.m28(new BooleanSetting("AutoElytra", true));
    private final EnumSetting hotbarSwap = (EnumSetting)this.m28(new EnumSetting("HotbarSwap", HotbarSwapMode.Swap));
    private final EnumSetting inventorySwap = (EnumSetting)this.m28(new EnumSetting("InventorySwap", InventorySwapMode.ClickSlot));
    private final BooleanSetting switchArmor = (BooleanSetting)this.m28(new BooleanSetting("SwitchArmor", false));
    private final EnumSetting notifyMode = (EnumSetting)this.m28(new EnumSetting("NotifyMode", EMode2.Hud));
    private final NumberSetting hudX = (NumberSetting)this.m28(new NumberSetting("HudX", 50.0, 0.0, 100.0, 0.1, 0.1, () -> {
        boolean bl = false;
        return (Boolean)this.switchArmor.getObj() != false && this.notifyMode.getObj() == EMode2.Hud;
    }, null, "", false));
    private final NumberSetting hudY = (NumberSetting)this.m28(new NumberSetting("HudY", 85.0, 0.0, 100.0, 0.1, 0.1, () -> {
        boolean bl = false;
        return (Boolean)this.switchArmor.getObj() != false && this.notifyMode.getObj() == EMode2.Hud;
    }, null, "", false));
    private final BooleanSetting autoSwitch = (BooleanSetting)this.m28(new BooleanSetting("AutoSwitch", false));
    private final EnumSetting switchMode = (EnumSetting)this.m28(new EnumSetting("SwitchMode", EMode.Item, () -> {
        boolean bl = false;
        if ((Boolean)this.switchArmor.getObj() == false) return false;
        if ((Boolean)this.autoSwitch.getObj() == false) return false;
        return true;
    }, null, "", false));
    private final NumberSetting enemySwordRange = (NumberSetting)this.m28(new NumberSetting("EnemySwordRange", 10.0, 1.0, 20.0, 0.1, 0.1, () -> {
        boolean bl = false;
        if ((Boolean)this.switchArmor.getObj() == false) return false;
        if ((Boolean)this.autoSwitch.getObj() == false) return false;
        if (this.switchMode.getObj() != EMode.Item) return false;
        return true;
    }, null, "", false));
    private final ColorSetting2 switchArmorKey = (ColorSetting2)this.m28(new ColorSetting2("SwitchArmorKey", -1, () -> {
        int n = AutoArmor.getInt66();
        boolean bl = (Boolean)this.switchArmor.getObj();
        if (n != 0) {
            if (!bl) return false;
            bl = (Boolean)this.autoSwitch.getObj();
        }
        if (n == 0) return bl;
        if (bl) return false;
        return true;
    }));
    private final BooleanSetting switchHead = (BooleanSetting)this.m28(new BooleanSetting("SwitchHead", true));
    private final BooleanSetting switchChest = (BooleanSetting)this.m28(new BooleanSetting("SwitchChest", true));
    private final BooleanSetting switchLegs = (BooleanSetting)this.m28(new BooleanSetting("SwitchLegs", true));
    private final BooleanSetting switchFeet = (BooleanSetting)this.m28(new BooleanSetting("SwitchFeet", true));
    private final NumberSetting switchDelay = (NumberSetting)this.m28(new NumberSetting("SwitchDelay", 1.0, 0.0, 5.0, 1.0));
    ...
    private boolean isSet95() {
        boolean bl = false;
        if ((Boolean)this.autoElytra.getObj() == false) return false;
    ...
    private boolean isSet91() {
        ...
        return MC.client3.player.getVelocity().horizontalLengthSquared() > 1.0E-4;
    }
    ...
    private void setObj75(Object object) {
        ...
        MC.client3.player.sendMessage((Text)Text.literal((String)("\u00a78[\u00a7dAutoArmor\u00a78] \u00a77" + string)), false);
    }
    ...
    public void setEvent2Inner(Event2.Event2Inner event2Inner) {
        ...
        if (((Boolean)this.switchArmor.getObj()).booleanValue()) {
            if (((Boolean)this.autoSwitch.getObj()).booleanValue()) {
                this.m623();
            } else if (MC.client3.currentScreen == null) {
                boolean bl;
                boolean bl2 = bl = (Integer)this.switchArmorKey.getObj() != -1 && InputUtil.isKeyPressed((Window)MC.client3.getWindow(), (int)((Integer)this.switchArmorKey.getObj()));
                if (bl) {
                    if (!this.flag139) {
                        this.flag139 = true;
        ...
        if (this.flag93 && !this.list32.isEmpty()) {
            ...
            this.setObj41(data);
            this.count139 = this.switchDelay.getInt50();
            if (this.list32.isEmpty()) {
                this.flag93 = false;
                if (this.notifyMode.getObj() == EMode2.Chat) {
        ...
        if (((Boolean)this.noMove.getObj()).booleanValue() && this.isSet91()) {
            return;
        }
        if (this.count228 > 0) {
            --this.count228;
        } else {
            this.count228 = this.delay.getInt50();
            this.m963();
        }
        if (((Boolean)this.switchArmor.getObj()).booleanValue()) {
    ...
    public void setObj17(Render2DEvent render2DEvent) {
        ...
        if (!((Boolean)this.switchArmor.getObj()).booleanValue() || this.notifyMode.getObj() != EMode2.Hud) {
            return;
        }
        ...
        int n2 = MC.client3.getWindow().getScaledWidth();
        int n3 = MC.client3.getWindow().getScaledHeight();
        int n4 = MC.client3.textRenderer.getWidth(string);
        int n5 = (int)((double)n2 * ((Double)this.hudX.getObj() / 100.0)) - n4 / 2;
        int n6 = (int)((double)n3 * ((Double)this.hudY.getObj() / 100.0));
        n5 = Math.max(0, Math.min(n5, n2 - n4));
        Objects.requireNonNull(MC.client3.textRenderer);
        n6 = Math.max(0, Math.min(n6, n3 - 9));
        drawContext.drawText(MC.client3.textRenderer, string, n5, n6, n, true);
    }
    ...
    private void m963() {
        ...
        map.put(EquipmentSlot.FEET, new int[]{36, this.m139(MC.client3.player.getInventory().getStack(36)), -1, -1});
        map.put(EquipmentSlot.LEGS, new int[]{37, this.m139(MC.client3.player.getInventory().getStack(37)), -1, -1});
        map.put(EquipmentSlot.CHEST, new int[]{38, this.m139(MC.client3.player.getInventory().getStack(38)), -1, -1});
        map.put(EquipmentSlot.HEAD, new int[]{39, this.m139(MC.client3.player.getInventory().getStack(39)), -1, -1});
        for (int var4 = 0; var4 < 36; ++var4) {
            ItemStack var5 = MC.client3.player.getInventory().getStack(var4);
            ...
            for (java.util.Map.Entry<EquipmentSlot, int[]> var10 : map.entrySet()) {
                if (this.isSet95() && var10.getKey() == EquipmentSlot.CHEST) {
                    ItemStack var11 = MC.client3.player.getInventory().getStack(38);
                    ...
                    boolean var15 = var14[2] != -1 && !MC.client3.player.getInventory().getStack(var14[2]).isEmpty() && MC.client3.player.getInventory().getStack(var14[2]).isOf(Items.ELYTRA) && MC.client3.player.getInventory().getStack(var14[2]).getDamage() < MC.client3.player.getInventory().getStack(var14[2]).getMaxDamage();
        ...
        for (java.util.Map.Entry<EquipmentSlot, int[]> var17 : map.entrySet()) {
            ...
            if (var19 < 9) {
                switch (((HotbarSwapMode)((Object)this.hotbarSwap.getObj())).ordinal()) {
                    case 0: {
                        MC.client3.interactionManager.clickSlot(MC.client3.player.playerScreenHandler.syncId, var20, var19, SlotActionType.SWAP, (PlayerEntity)MC.client3.player);
                        break;
                    }
                    case 1: {
                        int var21 = MC.client3.player.getInventory().getSelectedSlot();
                        MC.client3.player.getInventory().setSelectedSlot(var19);
                        MC.client3.interactionManager.interactItem((PlayerEntity)MC.client3.player, Hand.MAIN_HAND);
                        MC.client3.player.getInventory().setSelectedSlot(var21);
                    }
                }
            } else {
                switch (((InventorySwapMode)((Object)this.inventorySwap.getObj())).ordinal()) {
                    case 0: {
                        MC.client3.interactionManager.clickSlot(MC.client3.player.playerScreenHandler.syncId, var19, 0, SlotActionType.PICKUP, (PlayerEntity)MC.client3.player);
                        MC.client3.interactionManager.clickSlot(MC.client3.player.playerScreenHandler.syncId, var20, 0, SlotActionType.PICKUP, (PlayerEntity)MC.client3.player);
                        if (var18[1] != -1) {
                            MC.client3.interactionManager.clickSlot(MC.client3.player.playerScreenHandler.syncId, var19, 0, SlotActionType.PICKUP, (PlayerEntity)MC.client3.player);
                        }
                        break;
    ...
    private void m623() {
        ...
        block14: {
                ...
                block19: {
                    block20: {
                        ...
                        block18: {
                            ...
                            if (autoArmor.switchMode.getObj() != EMode.Item) break block14;
                            autoArmor = this;
                        }
                    ...
                    bl = MC.client3.player.isUsingItem();
                }
            ...
            boolean bl2 = bl;
            double d = (Double)this.enemySwordRange.getObj();
                        ...
                        block26: {
                            ...
                            block23: {
                                ...
                                block22: {
                                    ...
                                    if (n != 0) {
                                        if (playerEntity3 == MC.client3.player) continue;
                                        playerEntity3 = playerEntity;
                                    }
                                    n2 = playerEntity3.isAlive() ? 1 : 0;
                                    if (n != 0) {
                                        if (n2 == 0) continue;
                                        n2 = Client.manager.m258(playerEntity.getNameForScoreboard()) ? 1 : 0;
                                    }
                                    if (n == 0) break block22;
                                    if (n2 != 0) continue;
                                    playerEntity2 = MC.client3.player;
    ...
    private void setObj29(Object object) {
        ...
        if (((Boolean)this.switchHead.getObj()).booleanValue()) {
            this.m568(EquipmentSlot.HEAD, 39, (Object)type);
        }
        if (((Boolean)this.switchChest.getObj()).booleanValue()) {
            this.m568(EquipmentSlot.CHEST, 38, (Object)type);
        }
        if (((Boolean)this.switchLegs.getObj()).booleanValue()) {
            this.m568(EquipmentSlot.LEGS, 37, (Object)type);
        }
        if (((Boolean)this.switchFeet.getObj()).booleanValue()) {
    ...
    private void setObj47(Object object) {
        ...
        if (((Boolean)this.switchHead.getObj()).booleanValue()) {
            this.head.setObj94((Object)headMode);
        }
        if (((Boolean)this.switchChest.getObj()).booleanValue()) {
            this.body.setObj94((Object)headMode);
        }
        if (((Boolean)this.switchLegs.getObj()).booleanValue()) {
            this.tights.setObj94((Object)headMode);
        }
        if (((Boolean)this.switchFeet.getObj()).booleanValue()) {
            this.feet.setObj94((Object)headMode);
        }
    }
    ...
    private Type getType3() {
        ...
        block8: {
            ...
            nArray[0] = 39;
            boolean bl = (Boolean)this.switchHead.getObj();
            if (n4 != 0) {
                bl = bl;
            }
            nArray[1] = bl ? 1 : 0;
            ...
            nArray2[0] = 38;
            boolean bl2 = (Boolean)this.switchChest.getObj();
            if (n4 != 0) {
                bl2 = bl2;
            }
            nArray2[1] = bl2 ? 1 : 0;
            ...
            nArray3[0] = 37;
            boolean bl3 = (Boolean)this.switchLegs.getObj();
            if (n4 != 0) {
                bl3 = bl3;
            }
            nArray3[1] = bl3 ? 1 : 0;
            ...
            nArray4[0] = 36;
            boolean bl4 = (Boolean)this.switchFeet.getObj();
            if (n4 != 0) {
                bl4 = bl4;
            }
            nArray4[1] = bl4 ? 1 : 0;
            ...
            for (int[] nArray5 : nArrayArray = nArrayArray2) {
                ...
                if (n4 != 0) {
                    Type type;
                    if (n == 0) continue;
                    Type type2 = type = this.m912(MC.client3.player.getInventory().getStack(nArray5[0]));
            ...
            block13: {
                block12: {
                    ...
                    block11: {
                        ...
                        itemStack = MC.client3.player.getInventory().getStack(n5);
                        ...
                        block17: {
                            ...
                            block18: {
                                ...
                                block16: {
                                    ...
                                    block14: {
                                        itemStack4 = itemStack3 = MC.client3.player.getInventory().getStack(n7);
                                    ...
                                    object3 = this.ignoreCurse.getObj();
                                }
    ...
    private void setObj41(Object object) {
        block13: {
            ...
            block12: {
                ...
                boolean bl = false;
                if (MC.client3.player == null || MC.client3.interactionManager == null) {
                    return;
                }
                n2 = 44 - data.count3;
                n = data.count4;
                ...
                switch (((HotbarSwapMode)((Object)this.hotbarSwap.getObj())).ordinal()) {
                    case 0: {
                        MC.client3.interactionManager.clickSlot(MC.client3.player.playerScreenHandler.syncId, n2, n, SlotActionType.SWAP, (PlayerEntity)MC.client3.player);
                        if (!false) break;
                    }
                    case 1: {
            ...
            switch (((InventorySwapMode)((Object)this.inventorySwap.getObj())).ordinal()) {
                case 0: {
                    ...
                    MC.client3.interactionManager.clickSlot(MC.client3.player.playerScreenHandler.syncId, n2, 0, SlotActionType.PICKUP, (PlayerEntity)MC.client3.player);
                    MC.client3.interactionManager.clickSlot(MC.client3.player.playerScreenHandler.syncId, n, 0, SlotActionType.PICKUP, (PlayerEntity)MC.client3.player);
                    if (!false) break;
                }
                case 1: {
        ...
        block24: {
            ...
            block27: {
                ...
                if (n3 != 0) {
                    switch (n) {
                        case 1: {
                            if (this.head.getObj() == HeadMode.Protection) {
                                n7 = 2;
                                if (n3 != 0) break;
                            }
                            n6 = 2;
                        ...
                        case 2: {
                            if (this.body.getObj() == HeadMode.Protection) {
                                n7 = 2;
                                if (n3 != 0) break;
                            }
                            n6 = 2;
                        ...
                        case 3: {
                            if (this.tights.getObj() == HeadMode.Protection) {
                                n7 = 2;
                                if (n3 != 0) break;
                            }
                            n6 = 2;
                        ...
                        case 4: {
                            if (this.feet.getObj() == HeadMode.Protection) {
                                n7 = 2;
                                if (n3 != 0) break;
                            }
                            n6 = 2;
                    ...
                    block30: {
                        ...
                        block34: {
                            block33: {
                                ...
                                n8 = ((Boolean)this.ignoreCurse.getObj()).booleanValue() ? 1 : 0;
                            }
