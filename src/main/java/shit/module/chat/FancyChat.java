...
extends Module {
    ...
    private final Random random;
        ...
        this.uwu = (BooleanSetting)this.m28(new BooleanSetting("Uwu", true));
        this.leet = (BooleanSetting)this.m28(new BooleanSetting("Leet", false));
        this.green = (BooleanSetting)this.m28(new BooleanSetting("Green", false));
        this.blue = (BooleanSetting)this.m28(new BooleanSetting("Blue", false));
        this.mock = (BooleanSetting)this.m28(new BooleanSetting("Mock", false));
        this.randomCase = (BooleanSetting)this.m28(new BooleanSetting("RandomCase", true));
    ...
    public String getText57() {
        ...
        block8: {
            ...
            boolean bl = (Boolean)this.uwu.getObj();
            if (nArray != null) {
                if (bl) {
                    stringBuilder.append("uwu ");
                }
                bl = (Boolean)this.leet.getObj();
            }
            if (nArray != null) {
                if (bl) {
                    stringBuilder.append("1337 ");
                }
                bl = (Boolean)this.mock.getObj();
            }
            if (nArray != null) {
                if (bl) {
                    stringBuilder.append("mOcK ");
                }
                bl = (Boolean)this.green.getObj();
            }
            if (nArray != null) {
                if (bl) {
                    stringBuilder.append("> ");
                }
                bl = (Boolean)this.blue.getObj();
            }
            if (!bl) break block8;
            stringBuilder.append("` ");
        }
    ...
    public String m342(Object object) {
        ...
        block13: {
            ...
            block12: {
                ...
                object3 = string;
                int[] nArray = ChatTimestamp.getIntArray2();
                n = ((Boolean)this.uwu.getObj()).booleanValue() ? 1 : 0;
                if (nArray != null) {
                    if (n != 0) {
                        object3 = FancyChat.m857(object3);
                    }
                    n = ((Boolean)this.leet.getObj()).booleanValue() ? 1 : 0;
                }
                if (nArray != null) {
                    if (n != 0) {
                        object3 = this.m326(object3);
                    }
                    n = ((Boolean)this.mock.getObj()).booleanValue() ? 1 : 0;
                }
                if (nArray != null) {
                    if (n != 0) {
                        object3 = this.m349(object3);
                    }
                    n = ((Boolean)this.green.getObj()).booleanValue() ? 1 : 0;
                }
                if (nArray != null) {
                    if (n != 0) {
                        object3 = "> " + (String)object3;
                    }
                    n = ((Boolean)this.blue.getObj()).booleanValue() ? 1 : 0;
                }
    ...
    private String m349(Object var1_1) {
        ...
        for (int i = 0; i < string.length(); ++i) {
            ...
            boolean upper = ((Boolean)this.randomCase.getObj()).booleanValue() ? this.random.nextBoolean() : i % 2 == 0;
