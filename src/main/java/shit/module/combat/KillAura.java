...
extends Module {
    ...
    private final EnumSetting target = (EnumSetting)this.m28(new EnumSetting("Target", TargetMode.Players));
    private final NumberSetting range = (NumberSetting)this.m28(new NumberSetting("Range", 4.5, 1.0, 6.0, 0.1));
    private final NumberSetting delay = (NumberSetting)this.m28(new NumberSetting("Delay", 50.0, 0.0, 1000.0, 1.0));
    private final BooleanSetting rotate = (BooleanSetting)this.m28(new BooleanSetting("Rotate", true));
    private final BooleanSetting onlyWeapon = (BooleanSetting)this.m28(new BooleanSetting("OnlyWeapon", false));
    private final BooleanSetting skipCrystals = (BooleanSetting)this.m28(new BooleanSetting("SkipCrystals", true));
    private final BooleanSetting pauseIfUsing = (BooleanSetting)this.m28(new BooleanSetting("PauseIfUsing", true));
    ...
    public String getText57() {
        return ((TargetMode)((Object)this.target.getObj())).name();
    }
    ...
    private void setEvent2Inner25(Event2.Event2Inner event2Inner) {
        ...
        if (((Boolean)this.pauseIfUsing.getObj()).booleanValue() && MC.client3.player.isUsingItem()) {
            return;
        }
        if (((Boolean)this.onlyWeapon.getObj()).booleanValue() && !ItemUtil.m931(MC.client3.player)) {
            return;
        }
        if (!this.helper711.m432(((Double)this.delay.getObj()).doubleValue())) {
            return;
        }
        ...
        MC.client3.interactionManager.attackEntity(MC.client3.player, entity);
    ...
    private Entity m453() {
        Entity entity = null;
        double d = ((Double)this.range.getObj()).doubleValue();
        double d2 = Double.MAX_VALUE;
        TargetMode targetMode = (TargetMode)((Object)this.target.getObj());
        Iterator iterator = MC.client3.world.getEntities().iterator();
        while (iterator.hasNext()) {
            Entity entity2 = (Entity)iterator.next();
            if (!this.m289(entity2, targetMode)) continue;
            if (((Boolean)this.skipCrystals.getObj()).booleanValue() && entity2 instanceof EndCrystalEntity) continue;
            double d3 = MC.client3.player.distanceTo(entity2);
    ...
    private boolean m289(Entity entity, TargetMode targetMode) {
        ...
        switch (targetMode) {
            case Players: {
                ...
                if (AntiBot.INSTANCE != null && AntiBot.INSTANCE.isSet19() && AntiBot.m710(playerEntity)) return false;
                return true;
            }
            case Mobs: {
    ...
    private void m426(Entity entity) {
        double d = entity.getX() - MC.client3.player.getX();
        double d2 = entity.getEyeY() - MC.client3.player.getEyeY();
        double d3 = entity.getZ() - MC.client3.player.getZ();
        double d4 = Math.sqrt(d * d + d3 * d3);
        float f = (float)Math.toDegrees(Math.atan2(d3, d)) - 90.0f;
        float f2 = (float)(-Math.toDegrees(Math.atan2(d2, d4)));
        MC.client3.player.setYaw(f);
        MC.client3.player.setPitch(f2);
    }
