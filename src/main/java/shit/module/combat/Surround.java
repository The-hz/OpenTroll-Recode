...
extends Module {
    ...
    public final EnumSetting page = (EnumSetting)this.m28(new EnumSetting("Page", PageMode.General));
    public final NumberSetting placeDelay = (NumberSetting)this.m28(new NumberSetting("PlaceDelay", 50.0, 0.0, 500.0, 1.0, 1.0, () -> this.page.getObj() == PageMode.General, null, "", false));
    private final NumberSetting blocksPer = (NumberSetting)this.m28(new NumberSetting("BlocksPer", 1.0, 1.0, 8.0, 1.0, 1.0, () -> this.page.getObj() == PageMode.General, null, "", false));
    private final BooleanSetting mineDownward = (BooleanSetting)this.m28(new BooleanSetting("MineDownward", false, () -> this.page.getObj() == PageMode.General, null, "", false));
    public final BooleanSetting extend = (BooleanSetting)this.m28(new BooleanSetting("Extend", true, () -> this.page.getObj() == PageMode.General, null, "", false));
    public final BooleanSetting onlySelf = (BooleanSetting)this.m28(new BooleanSetting("OnlySelf", false, () -> {
        Object var1_1 = null;
        if (this.page.getObj() != PageMode.General) return false;
        if ((Boolean)this.extend.getObj() == false) return false;
        return true;
    }, null, "", false));
    private final BooleanSetting break_ = (BooleanSetting)this.m28(new BooleanSetting("Break", true, () -> this.page.getObj() == PageMode.General, null, "", false));
    private final BooleanSetting eatingPause = (BooleanSetting)this.m28(new BooleanSetting("EatingPause", true, () -> {
        Object var1_1 = null;
        if (this.page.getObj() != PageMode.General) return false;
        if ((Boolean)this.break_.getObj() == false) return false;
        return true;
    }, null, "", false));
    private final BooleanSetting center = (BooleanSetting)this.m28(new BooleanSetting("Center", true, () -> this.page.getObj() == PageMode.General, null, "", false));
    private final BooleanSetting enderChest = (BooleanSetting)this.m28(new BooleanSetting("EnderChest", true, () -> this.page.getObj() == PageMode.General, null, "", false));
    private final EnumSetting switchMode = (EnumSetting)this.m28(new EnumSetting("SwitchMode", EMode.DEFAULT, () -> this.page.getObj() == PageMode.General, null, "", false));
    private final EnumSetting rotateMode = (EnumSetting)this.m28(new EnumSetting("RotateMode", EMode2.DEFAULT, () -> this.page.getObj() == PageMode.Rotate, null, "", false));
    public final BooleanSetting inAir = (BooleanSetting)this.m28(new BooleanSetting("InAir", true, () -> this.page.getObj() == PageMode.Check, null, "", false));
    private final BooleanSetting detectMining = (BooleanSetting)this.m28(new BooleanSetting("DetectMining", false, () -> this.page.getObj() == PageMode.Check, null, "", false));
    private final BooleanSetting usingPause = (BooleanSetting)this.m28(new BooleanSetting("UsingPause", true, () -> this.page.getObj() == PageMode.Check, null, "", false));
    private final BooleanSetting moveDisable = (BooleanSetting)this.m28(new BooleanSetting("MoveDisable", true, () -> this.page.getObj() == PageMode.Check, null, "", false));
    private final BooleanSetting jumpDisable = (BooleanSetting)this.m28(new BooleanSetting("JumpDisable", true, () -> this.page.getObj() == PageMode.Check, null, "", false));
        ...
        block2: {
            block4: {
                block3: {
                    ...
                    if (((Boolean)this.moveDisable.getObj()).booleanValue()) break block3;
                    if (!((Boolean)this.jumpDisable.getObj()).booleanValue()) break block4;
                }
                this.setFlag3(false);
            }
            return;
        }
        this.value126 = MC.client3.player.getX();
        this.value194 = MC.client3.player.getY();
        this.value164 = MC.client3.player.getZ();
        this.time67 = 0L;
        this.count64 = 0;
        this.flag125 = true;
    }
    ...
    private void setEvent2Inner37(Event2.Event2Inner event2Inner) {
        ...
        if (!bl && MC.client3.currentScreen instanceof HandledScreen) {
            return;
        }
        if (System.currentTimeMillis() - this.time67 < (long)this.placeDelay.getInt50()) {
            return;
        }
        this.count64 = 0;
        if (!this.isSet77() && !MC.client3.player.input.playerInput.jump()) {
            this.value126 = MC.client3.player.getX();
            this.value194 = MC.client3.player.getY();
            this.value164 = MC.client3.player.getZ();
        }
        double d = MathHelper.sqrt((float)((float)MC.client3.player.squaredDistanceTo(this.value126, this.value194, this.value164)));
        if (this.getInt48() == -1) {
            this.setFlag3(false);
            return;
        }
        if (((Boolean)this.moveDisable.getObj()).booleanValue() && d > 1.0) {
            this.setFlag3(false);
            return;
        }
        if (((Boolean)this.jumpDisable.getObj()).booleanValue() && MC.client3.player.input.playerInput.jump()) {
            this.setFlag3(false);
            return;
        }
        ...
        if (!((Boolean)this.inAir.getObj()).booleanValue() && !MC.client3.player.isOnGround()) {
            return;
        }
        BlockPos blockPos = BlockPos.ofFloored((double)MC.client3.player.getX(), (double)MC.client3.player.getY(), (double)MC.client3.player.getZ());
        this.setObj19(blockPos);
        this.setObj19(BlockPos.ofFloored((double)MC.client3.player.getX(), (double)(MC.client3.player.getY() + 0.8), (double)MC.client3.player.getZ()));
        if (this.count64 == 0) {
            Client.mathUtil.m370();
        }
    }
    ...
    private void setMoveEvent2(MoveEvent moveEvent) {
        if (Module.isSet37() || !((Boolean)this.center.getObj()).booleanValue() || MC.client3.player.isGliding()) {
            return;
        }
        BlockPos blockPos = BlockPos.ofFloored((double)MC.client3.player.getX(), (double)MC.client3.player.getY(), (double)MC.client3.player.getZ());
        double d = MC.client3.player.getX() - (double)blockPos.getX() - 0.5;
        double d2 = MC.client3.player.getZ() - (double)blockPos.getZ() - 0.5;
        if (Math.abs(d) <= 0.2 && Math.abs(d2) <= 0.2) {
            if (this.flag125 && (MC.client3.player.isOnGround() || this.isSet77())) {
            ...
            float[] fArray = MathUtil.m547(MC.client3.player.getEntityPos(), new Vec3d(vec3d.x, MC.client3.player.getY(), vec3d.z));
            float f = fArray[0] / 180.0f * (float)Math.PI;
            double d3 = MC.client3.player.getEntityPos().distanceTo(new Vec3d(vec3d.x, MC.client3.player.getY(), vec3d.z));
    ...
    public void setObj19(Object object) {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            if (!((Boolean)this.extend.getObj()).booleanValue()) continue;
            if (!Surround.m626(blockPos2)) {
                if (((Boolean)this.onlySelf.getObj()).booleanValue() || !Surround.m612(blockPos2)) continue;
            }
            for (Direction direction2 : Direction.values()) {
                ...
                block8: {
                    block7: {
                        ...
                        if (((Boolean)this.onlySelf.getObj()).booleanValue() || !Surround.m612(blockPos3)) break block8;
                    }
    ...
    private void setObj88(Object object) {
        block22: {
            ...
            block21: {
                ...
                if (this.count64 >= this.blocksPer.getInt50()) {
                    return;
                }
                if (!this.m767(blockPos)) {
                    return;
                }
                if (((Boolean)this.mineDownward.getObj()).booleanValue()) {
                    if (MC.client3.interactionManager.isBreakingBlock()) {
                        BlockPos playerPos = BlockPos.ofFloored((double)MC.client3.player.getX(), (double)MC.client3.player.getY(), (double)MC.client3.player.getZ());
                ...
                if (MC.client3.player.getEyePos().distanceTo(vec3d) > 6.0) {
                    return;
                }
                ...
                if (((Boolean)this.break_.getObj()).booleanValue()) {
    ...
    private boolean m509(Object object) {
        ...
        Iterator iterator = MC.client3.world.getOtherEntities(null, box).iterator();
        Object var4_5 = null;
    ...
    private int getInt48() {
        ...
        int n;
        Object var2_2 = null;
        for (n = 0; n < MC.client3.player.getInventory().size(); ++n) {
            itemStack = MC.client3.player.getInventory().getStack(n);
    ...
    private boolean isSet77() {
        Object var2_1 = null;
        return MC.client3.player.getVelocity().horizontalLengthSquared() > 1.0E-6;
    }

    private ClientSetting.RotateMode getRotateMode2() {
        Object var2_1 = null;
        if (this.rotateMode.getObj() == EMode2.DEFAULT) {
        ...
        return switch (((EMode2)((Object)this.rotateMode.getObj())).ordinal()) {
