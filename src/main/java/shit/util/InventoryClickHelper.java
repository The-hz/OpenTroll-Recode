...
implements MC {
    ...
    public static int m189(Object object, boolean n) {
        ...
        return InventoryClickHelper.m864(predicate, n3, 36);
    }
    ...
    public static boolean m334(int n, int n2) {
        ...
        block4: {
            ...
            n4 = InventoryClickHelper.m589(n6);
            n3 = n5;
        }
        InventoryClickHelper.m235(n4, n3, SlotActionType.SWAP);
        return true;
    }
    ...
    public static int getInt20() {
        boolean bl = false;
        int n = InventoryClickHelper.isSet48() ? 1 : 0;
        if (false) {
            if (n == 0) {
                return 0;
            }
