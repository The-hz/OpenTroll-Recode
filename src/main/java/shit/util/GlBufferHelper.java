...
public final class GlBufferHelper {
    private static final MemoryWriteHelper bufferUtil4 = new MemoryWriteHelper();
    private static final MemoryWriteHelper bufferUtil5 = new MemoryWriteHelper();
    ...
    @Environment(value=EnvType.CLIENT)
    static class MemoryWriteHelper {
        ...
        private MemoryWriteHelper m343(double d, double d2) {
            double d3 = d;
            double d4 = d2;
            long l = this.time24;
