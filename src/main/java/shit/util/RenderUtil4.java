...
public class RenderUtil4 {
    ...
    public static void m486() {
        GpuBufferSlice gpuBufferSlice = field25.set(RenderUtil4.getFloat57(), RenderUtil4.getFloat53());
    ...
    public static Data m1023(int n) {
        int n2 = n;
        return RenderUtil4.m369(n2, true);
    }
    ...
    public static Data m369(int n, boolean bl) {
        ...
        GpuTextureView gpuTextureView2 = RenderUtil4.getGpuTextureView4();
    ...
    public static GpuBufferSlice getGpuBufferSlice2() {
        return RenderUtil4.m998(RenderSystem.getModelViewMatrix(), new Vector4f(1.0f, 1.0f, 1.0f, 1.0f), new Vector3f(0.0f, 0.0f, 0.0f), TextureTransform.DEFAULT_TEXTURING.getTransformSupplier());
    }
    ...
    implements AutoCloseable {
        ...
        private AutoCloseableImpl(String string, int n, int n2, boolean bl) {
            ...
            this.count188 = n2;
            this.flag30 = bl;
            this.field62 = BufferUtil2.m52("lumin-rt" + string);
            this.m996();
        }
        ...
        public void close() {
            this.m659();
            Manager3.manager3.setObj93(this);
        }
    }
