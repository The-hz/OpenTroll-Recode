...
public class AnimationWidgetRenderer {
    ...
    public AnimationWidgetRenderer(String string, float f, Runnable runnable) {
    ...
    public void setObj113(Object object) {
        ...
        float f = 1.0f;
        int n3 = AnimationWidgetRenderer.m837(AnimationWidgetRenderer.m255((Object) this.type3), AnimationWidgetRenderer.m255((Object) this.type12), EasingMode.OUT_EXPO.m984(EasingMode.m164(this.time32, 300.0f)));
        float f2 = value172;
        VanillaTextHelper.m919(drawContext, Math.round(this.value117 + 1.0f), Math.round(this.value180 + 1.0f), Math.round(this.value117 + f2 + 2.0f), Math.round(this.value180 + f + 2.0f), -1606401984);
        VanillaTextHelper.m919(drawContext, Math.round(this.value117), Math.round(this.value180), Math.round(this.value117 + f2), Math.round(this.value180 + f), n3);
    ...
    static {
        ...
        boolean bl = false;
        AnimationWidgetRenderer.setIntArray2(null);
        value172 = 60.0f;
    }
