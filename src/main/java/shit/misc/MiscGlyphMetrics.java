...
public class MiscGlyphMetrics {
    ...
    public MiscGlyphMetrics(Identifier identifier, int n, int n2) {
        this.byteBuffer2 = shit.util.ResourceLoader.m37(identifier);
     ...
     */
    public synchronized BufferUploadData m728(int var1_1) {
        ...
        try (MemoryStack memoryStack = MemoryStack.stackPush();){
            ...
            return new BufferUploadData((ByteBuffer)sdf, (int)width.get(), (int)height.get(), (int)xoff.get(), (int)yoff.get(), (int)((float)advance.get() * this.value119));
        }
    }
