...
public class MiscGlyphBufferUtil {
    ...
    public Vec4f m359(Object object) {
        BufferUploadData bufferData = (BufferUploadData)object;
        Module[] moduleArray = ShaderRenderer.getModuleArray();
        BufferUploadData bufferData2 = bufferData;
        if (moduleArray != null) {
