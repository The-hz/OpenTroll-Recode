...
public class EmptySettingRenderer
extends ModuleState {
    ...
    public EmptySettingRenderer(TextRenderer textRenderer, Setting setting) {
        ...
        block3: {
            ...
            block7: {
                block6: {
                    ...
                    object2 = this.flag48 ? I18nHelper.m14("Press key/mouse...") : colorSetting2.getDisplayName();
                    ...
                    String string2 = "[" + I18nHelper.m14(colorSetting2.getType().name()) + "]";
